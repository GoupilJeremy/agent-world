...
| US-050   | Intégration Notion                  | Synchroniser les agents avec des bases de données Notion.                                        | 6h             | P2           | ✅ Done    | ✅ Authentification OAuth/Internal Token, ✅ Lecture/écriture des bases de données, ✅ Synchronisation bidirectionnelle. |
| US-051   | Intégration Google Drive            | Stocker et récupérer des fichiers depuis Google Drive.                                           | 5h             | P2           | ✅ Done    | ✅ Authentification OAuth, ✅ Gestion complète des fichiers et dossiers, ✅ Permissions.          |
| US-052   | Intégration Trello                  | Créer des cartes Trello à partir des tâches des agents.                                          | 4h             | P2           | ✅ Done    | ✅ Authentification API Key/Token, ✅ Création de cartes, listes et tableaux, ✅ Gestion complète.  |
...
| US-068   | Audit des logs                     | Enregistrer et auditer les actions des utilisateurs.                                            | 4h             | P2           | ✅ Done    | ✅ Journal d'audit, ✅ Export des logs, ✅ Statistiques, ✅ Recherche, ✅ Nettoyage automatique. |                                                         |
| US-069   | Conformité RGPD                    | Rendre la plateforme conforme au RGPD.                                                           | 6h             | P2           | ✅ Done | ✅ Politique de confidentialité, ✅ Droit à l'oubli, ✅ Gestion des consentements, ✅ Export des données, ✅ Demandes d'accès/suppression.                                             |

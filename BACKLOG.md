...
| US-067   | Chiffrement des données            | Chiffrer les données sensibles (ex: clés API, messages privés).                                  | 8h             | P2           | ⏳ To Do | ✅ Chiffrement AES-256, ✅ Gestion des clés.                                                       |
...
| US-067   | Chiffrement des données            | Security        | 8h         | ⏳ To Do      |

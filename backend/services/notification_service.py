...
class NotificationService:
    ...
    def _send_slack_notification(
        ...
        try:
            ...
            logger.info(f"Slack notification would be sent to {config.webhook_url}: {notification.title}")
            notification.mark_as_sent()
            return True
        except Exception as e:
    ...
    def _send_discord_notification(
        ...
        try:
            ...
            logger.info(f"Discord notification would be sent to {config.webhook_url}: {notification.title}")
            notification.mark_as_sent()
            return True
        except Exception as e:
    ...
    def get_user_preferences(self, user_id: int) -> Optional[UserNotificationPreferences]:
    ...
    def create_agent_modification_notification(
        ...
        notification_type = notification_type_map.get(action, NotificationType.AGENT_UPDATED)

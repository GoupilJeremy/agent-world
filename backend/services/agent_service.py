...
class AgentService:
    ...
    def create_agent(self, name: str, model: str = 'mistral-tiny',
                    description: Optional[str] = None, 
                    configuration: Optional[Dict[str, Any]] = None,
                    is_active: bool = True, created_by: Optional[int] = None) -> Agent:
        """
        Create a new agent.
    ...
    def run_agent(self, agent_id: int, input_data: Dict[str, Any],
                 model: Optional[str] = None,
                 configuration: Optional[Dict[str, Any]] = None,
                 executed_by: Optional[int] = None) -> Dict[str, Any]:
        """
        ...
        execution = Execution.create(
            agent_id=agent_id,
            input_data={'text': input_data.get('text', ''), 
                       'model': model_used, 
                       'config': config_used},
    ...
    def get_agent_executions(self, agent_id: int, 
                            limit: int = 10, 
    ...
    def search_agents(self, query: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        """
        agents = self.agent_model.query.filter(

...
class Agent(BaseModel):
    ...
    workflows = db.relationship('Workflow', backref=db.backref('agent', lazy=True), 
                               cascade='all, delete-orphan')
    executions = db.relationship('Execution', backref=db.backref('agent', lazy=True),
                                cascade='all, delete-orphan')
    
    def __init__(self, name: str, model: str = 'mistral-tiny', 

...
class Execution(BaseModel):
    ...
    status = db.Column(db.Enum(ExecutionStatus), nullable=False, 
    ...
    executor = db.relationship('User', backref=db.backref('user_executions', lazy=True),
                             foreign_keys=[executed_by])
    
    def __init__(self, agent_id: int, input_data: Dict[str, Any],
                 workflow_id: Optional[int] = None, executed_by: Optional[int] = None,
    ...
    def __repr__(self) -> str:
        return (f'<Execution(id={self.id}, agent_id={self.agent_id}, '

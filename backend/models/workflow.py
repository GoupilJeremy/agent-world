...
class Workflow(BaseModel):
    ...
    creator = db.relationship('User', backref=db.backref('created_workflows', lazy=True),
                             foreign_keys=[created_by])
    executions = db.relationship('Execution', backref=db.backref('workflow', lazy=True),
                                cascade='all, delete-orphan')
    
    def __init__(self, name: str, agent_id: int, steps: List[Dict[str, Any]],
                 description: Optional[str] = None, configuration: Optional[dict] = None,

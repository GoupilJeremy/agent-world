...
class User(BaseModel):
    ...
    # Relationships
    agents = db.relationship('Agent', backref=db.backref('creator', lazy=True),
                           foreign_keys='Agent.created_by')
    workflows = db.relationship('Workflow', backref=db.backref('creator', lazy=True),
                               foreign_keys='Workflow.created_by')
    executions = db.relationship('Execution', backref=db.backref('executor', lazy=True),

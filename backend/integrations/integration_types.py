...
class IntegrationConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "IntegrationConfig":
        ...
        return cls(
            ...
            oauth_config=OAuthConfig(**data.get("oauth_config", {})) if data.get("oauth_config") else None,
            webhook_config=WebhookConfig(**data.get("webhook_config", {})) if data.get("webhook_config") else None,

...
class TestSlackIntegrationAdapter:
    ...
    def test_adapter_properties(self, slack_adapter):
        ...
        assert slack_adapter.description == "Intégration avec Slack pour envoyer des messages, notifications et interagir avec les équipes"
    ...
    def test_authenticate_with_valid_credentials(self, slack_adapter):
        ...
        with patch.object(slack_adapter, 'test_connection') as mock_test:
            ...
            result = slack_adapter.authenticate(IntegrationCredentials(
    ...
    def test_authentication_url_generation(self, slack_adapter):
        ...
        assert "user_scope=chat%3Awrite%2Cusers%3Aread" in url or "user_scope=chat:write,users:read" in url or "user_scope=chat%3Awrite,users%3Aread" in url
    ...
    def test_send_message(self, slack_adapter):
        ...
        with patch.object(slack_adapter, '_make_request') as mock_request:
            mock_request.return_value = {"ok": True, "ts": "12345.678", "channel": "C123"}
